...
( function( $ ) {
    ...
    Object.freeze(RBParallaxCreator);
    ...
    class RB_Parallax{
        ...
        updateValuesIfNecessary(forceUpdate){
            if( forceUpdate ||
        ...
        //Returns the settings of an element based on its attributes
        ...
        stablishTheSettings(settings){
            ...
            //The settings stablished through the element attributes will override the ones passed by parameter
